...
contract book{
    ...
    function stu(uint256 id,string name)public {
     ...
     function display(uint256 bid,uint256 id)public constant returns(uint256,string,uint256,uint256){
               
                   return(lbk[bid].count,lbk[bid].bname,lbk[bid].bid,lbk[bid].stock);
     }
